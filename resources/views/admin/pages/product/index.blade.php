    ...
    <div class="tabs-container desktop-only">
        <div class="tabs">
            ...
            <div class="form-container-buttons">
                <div class="svg-box">
                    <div class="store-button" data-url="{{route('products_store')}}">
                        <svg viewBox="0 0 24 24">
                            ...
                            <div class="column">
                                <div class="form-element">
                                    ...
                                    <div class="form-element-input">
                                        <input type="text" name="name" value="{{isset($product->name) ? $product->name : ''}} " placeholder="Escribe aquí tu Nombre" aria-invalid="false">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="desktop-one-column">
                            <div class="column">
                                <div class="form-element">
                                    ...
                                    <div class="form-element-input">
                                        <input type="text" name="title" value="{{isset($product->title) ? $product->title : ''}} " placeholder="Escribe aquí tu Título" aria-invalid="false">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="desktop-one-column">
                            <div class="column">
                                <div class="form-element">
                                    ...
                                    <div class="form-element-input">
                                        <input type="text" name="price" value="{{isset($product->price) ? $product->price : ''}} " placeholder="Escribe aquí el precio" aria-invalid="false">
                                    </div>
                                </div>
                            </div>
                        </div>
