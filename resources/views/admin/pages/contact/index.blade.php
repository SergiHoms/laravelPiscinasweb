            ...
            @foreach($contact as $contact_element)
                <div class="table-container">
                    <ul class="table-item-info">
                        ...
                        <li><span>Nombre:</span>{{$contact_element->name}}</li>
                        <li><span>Creado el:</span>{{$contact_element->created_at}}</li>                                                                
                    </ul>
                    <div class="table-item-buttons">
                        <div class="edit-button" data-url="{{route('contacts_edit', ['contact' => $contact_element->id])}}">
                            <svg viewBox="0 0 24 24">
                                <path fill="currentColor" d="M20.71,7.04C21.1,6.65 21.1,6 20.71,5.63L18.37,3.29C18,2.9 17.35,2.9 16.96,3.29L15.12,5.12L18.87,8.87M3,17.25V21H6.75L17.81,9.93L14.06,6.18L3,17.25Z" />
                            </svg>
                        </div>
                        <div class="delete-button" data-url="{{route('contacts_destroy', ['contact' => $contact_element->id])}}">
                            <svg viewBox="0 0 24 24">
    ...
    <div class="tabs-container desktop-only">
        <div class="tabs">
            ...
            <div class="form-container-buttons">
                <div class="svg-box">
                    <div class="store-button" data-url="{{route('contacts_store')}}">
                        <svg viewBox="0 0 24 24">
                            <path fill="currentColor" d="M15,9H5V5H15M12,19A3,3 0 0,1 9,16A3,3 0 0,1 12,13A3,3 0 0,1 15,16A3,3 0 0,1 12,19M17,3H5C3.89,3 3,3.9 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V7L17,3Z" />
                        </svg>
                    </div>
                    <div class="create-button"data-url="{{route('contacts_create')}}">
                        <svg viewBox="0 0 24 24">
                            ...
                            <div class="column">
                                <div class="form-element">
                                    ...
                                    <div class="form-element-input">
                                        <input type="text" name="name" value="{{isset($contact->name) ? $contact->name : ''}} " placeholder="Escribe aquí tu Nombre" aria-invalid="false">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="desktop-one-column">
                            <div class="column">
                                <div class="form-element">
                                    ...
                                    <div class="form-element-input">
                                        <input type="text" name="surname" value="{{isset($contact->surname) ? $contact->surname : ''}} " placeholder="Escribe aquí tu Apellido" aria-invalid="false">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="desktop-one-column">
                            <div class="column">
                                <div class="form-element">
                                    ...
                                    <div class="form-element-input">
                                        <input type="text" name="phone" value="{{isset($contact->phone) ? $contact->phone : ''}} " placeholder="Escribe aquí tu Título" aria-invalid="false">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="desktop-one-column">
                            <div class="column">
                                <div class="form-element">
                                    ...
                                    <div class="form-element-input">
                                        <input type="text" name="email" value="{{isset($contact->email) ? $contact->email : ''}} " placeholder="Escribe aquí el Email" aria-invalid="false">
                                    </div>
                                </div>
                            </div>
                        </div>
