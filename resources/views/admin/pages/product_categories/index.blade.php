            ...
            @foreach($categories as $category_element)
                <div class="table-container">
                    <ul class="table-item-info">
                        <li><span>Id:</span>{{$category_element->id}}</li>
                        <li><span>Nombre:</span>{{$category_element->name}}</li>
                        <li><span>Creado el:</span>{{$category_element->created_at}}</li>                                                                
                    </ul>
                                ...
                                <div class="column">
                                    <div class="form-element">
                                        ...
                                        <div class="form-element-input">
                                            <input type="text" name="name" value="{{isset($category->name) ? $category->name : ''}} " placeholder="Escribe aquí tu Nombre" aria-invalid="false">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="desktop-one-column">
                                <div class="column">
                                    <div class="form-element">
                                        ...
                                        <div class="form-element-input">
                                            <input type="text" name="title" value="{{isset($category->title) ? $category->title : ''}} " placeholder="Escribe aquí tu Título" aria-invalid="false">
                                        </div>
                                    </div>
                                </div>
                            </div>
